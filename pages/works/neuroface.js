    ...
    return (
        <Layout title="NeuroFace">
            <Container>
                ...
                <P>
                    A Deep Learning model that uses machine learning to identify
                    and assess neurological conditions like ALS through facial
                    landmarking data from external videos.
                </P>
                <List ml={4} my={4}>
                    <ListItem>
                        <Meta>Website</Meta>
                    ...
                    <ListItem>
                        <Meta>Stack</Meta>
                        <span>
                            Python, PyTorch, Keras, Sci-kit Learn, Mediapipe
                        </span>
                    </ListItem>
                </List>
