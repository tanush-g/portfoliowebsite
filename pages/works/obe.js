    ...
    return (
        <Layout title="Outcome Based Education Student Portal">
            <Container>
                ...
                <P>
                    A web application that implements the OBE grading system,
                    allows students to view and professors to assign their
                    grades, class schedules, and other academic information.
                </P>
                <List ml={4} my={4}>
                    <ListItem>
                        <Meta>Website</Meta>
                    ...
                    <ListItem>
                        <Meta>Features</Meta>
                        <span>
                            User Roles, Auth, Coursework Management, Dashboards,
                            Data Visualisation
                        </span>
                    </ListItem>
                </List>
