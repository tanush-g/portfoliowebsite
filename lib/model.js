...
import { MathUtils } from "three" // Added for rotation conversion
  ...
  return new Promise((resolve, reject) => {
    ...
    loader.load(
      ...
      gltf => {
        ...
        // Rotate around X-axis to tilt it backwards (negative value tilts backwards)
        obj.rotation.x = MathUtils.degToRad(-15) // Tilt backwards by 10 degrees
